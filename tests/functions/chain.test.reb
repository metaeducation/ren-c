...
(
    ...
    mp-ad-ad: cascade [get $multiply, get $add-one, get $add-one]
    202 = (mp-ad-ad 10 20)
)
(
    ...
    mp-normal: cascade [get $mp-ad-ad, get $sub-one, get $sub-one]
    200 = (mp-normal 10 20)
)
...
(
    metatranscode: cascade [get $transcode, get $meta/except]
    e: metatranscode "1&e"
    all [
        error? e
        e.id = 'scan-invalid
