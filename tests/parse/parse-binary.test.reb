...
[
    ...
    (not uparse? #{0A0A} [repeat ([1 1]) [#{0A}]])
    (uparse? #{0A0A} [repeat ([1 2]) [#{0A}]])
    (uparse? #{0A0A} [repeat ([2 2]) [#{0A}]])
    (uparse? #{0A0A} [repeat ([2 3]) [#{0A}]])
    (not uparse? #{0A0A} [repeat ([3 4]) [#{0A}]])
    (not uparse? #{0A0A} [repeat ([1 1]) #{0A}])
    (uparse? #{0A0A} [repeat ([1 2]) #{0A}])
    (uparse? #{0A0A} [repeat ([2 2]) #{0A}])
    (uparse? #{0A0A} [repeat ([2 3]) #{0A}])
    (not uparse? #{0A0A} [repeat ([3 4]) #{0A}])
    (not uparse? #{0A0A} [repeat ([1 1]) <any>])
    (uparse? #{0A0A} [repeat ([1 2]) <any>])
    (uparse? #{0A0A} [repeat ([2 2]) <any>])
    (uparse? #{0A0A} [repeat ([2 3]) <any>])
    (not uparse? #{0A0A} [repeat ([3 4]) <any>])
