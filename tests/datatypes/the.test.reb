; %the.test.reb
;
; @ is a WORD! that is used as a special literalizing operator, that turns
; quasiforms into antiforms but passes through all else with binding.
;
; The other THE-XXX! types evaluate to add binding and drop the decoration.
;
