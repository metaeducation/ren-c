// !!! File now derived from a snapshot of `mbedtls/include/mbedtls_config.h`
// in mbedTLS v3.6 circa June 2025.  It has been edited from the master list
// of defines to add or remove switches for Rebol, but leaving the comments
// and options in place for reference.
//
...
//
// Historically this has made it relatively easy to sync up the configuration
// with subsequent releases of `mbedtls_config.h`.  However, since mbedTLS is
// going a different direction with 4.0 this won't be the case in the future.
// See README.md regarding this unfortunate situation.
//
...
#define MBEDTLS_PLATFORM_SNPRINTF_ALT  // REBENABLE (we use tf_snprintf)
 ...
 */
// REBDISABLE  #define MBEDTLS_PK_PARSE_EC_COMPRESSED
 ...
 * Requires: MBEDTLS_PSA_CRYPTO_C
 */
// REBDISABLE  #define MBEDTLS_PSA_KEY_STORE_DYNAMIC
 ...
 */
// REBDISABLE  #define MBEDTLS_SSL_DTLS_CONNECTION_ID
 ...
 */
// REBDISABLE  #define MBEDTLS_SSL_DTLS_CONNECTION_ID_COMPAT 0
 ...
 */
// REBDISABLE  #define MBEDTLS_SSL_CONTEXT_SERIALIZATION
 ...
 */
// REBDISABLE  #define MBEDTLS_SSL_KEYING_MATERIAL_EXPORT
 ...
 */
// REBDISABLE  #define MBEDTLS_SSL_PROTO_TLS1_3
 ...
 */
// REBDISABLE  #define MBEDTLS_AESCE_C
 ...
 */
// REBDISABLE  #define MBEDTLS_CTR_DRBG_C
 ...
 */
// REBDISABLE  #define MBEDTLS_LMS_C
 ...
 */
// REBDISABLE  #define MBEDTLS_PKCS5_C
 ...
 */
// REBDISABLE  #define MBEDTLS_PKCS7_C
 ...
 */
// REBDISABLE  #define MBEDTLS_PKCS12_C
 ...
 */
// REBDISABLE  #define MBEDTLS_PSA_CRYPTO_C
 ...
 */
// REBDISABLE  #define MBEDTLS_PSA_CRYPTO_STORAGE_C
 ...
 */
// REBDISABLE  #define MBEDTLS_SHA3_C  // SHA2 is enough for SHA-256/SHA-512
...
#define MBEDTLS_PLATFORM_CALLOC_MACRO        calloc /**< Default allocator macro to use, can be undefined. See MBEDTLS_PLATFORM_STD_CALLOC for requirements. */  // REBENABLE
#define MBEDTLS_PLATFORM_FREE_MACRO            free /**< Default free macro to use, can be undefined. See MBEDTLS_PLATFORM_STD_FREE for requirements. */  // REBENABLE
