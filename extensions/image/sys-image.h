...
extern Bounce MAKE_Image(REBVAL *out, enum Reb_Kind kind, option(const REBVAL*) parent, const REBVAL *arg);
extern Bounce TO_Image(REBVAL *out, enum Reb_Kind kind, const REBVAL *arg);
