...
(NOTE: This README.md is for what is the bootstrap build at time of writing,
which means these executables are actually what's referred to as R3PREBOOT).
...
The "preboot" commit is currently at git commit short hash: 8994d23
