...
dump: function [
    ...
    case [
        swp: match [set-word! set-path!] :value [ ; `dump x: 1 + 2`
            pos: evaluate/step3 extra (the result:)
            set swp :result
            print [swp  result]
        ]
...
dump-obj: function [
    ...
    return collect [
        wild: did all [set? 'pat  text? cond pat  find pat "*"]
        ...
        for-each [word val] obj [
            ...
            str: if lib/match [action! object!] cond :type [
