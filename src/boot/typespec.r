...
nulled      ["falsey state representing soft failure" nulled]
object      ["context of names with values" context]
okay        ["truthy antiform state in contrast to null" okay]
...
trash       ["contents of an unset variable" trash]
tripwire    ["named variant of an unset state" string]
