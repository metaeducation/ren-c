...
systems: [
    ...
    0.9.05 _ "sparc"
        ; was: "OpenBSD Sparc 1.2.1.9.5 view-pro095.tar.gz"
    ...
    ;-------------------------------------------------------------------------
    0.10.01 _ "sparc"
        ; was: "Sun Solaris Sparc 1.2.1.10.1 view-pro101.tar.gz"

    0.10.02 _ _
        ; was: "Solaris iX86 1.2.1.10.2 view-pro102.tar.gz"

    SGI: 11
    ;-------------------------------------------------------------------------
    0.11.0 _ _
        ; was: "SGI IRIX SGI 1.2.1.11 view-pro110.tar.gz"

    HP: 12
    ;-------------------------------------------------------------------------
    0.12.0 _ _
        ; was: "HP HP-UX HP 1.2.1.12 view-pro120.tar.gz"
