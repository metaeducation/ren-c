...
const struct {
    ...
    {SYM_ANY_THE_VALUE_X, TS_THE_VALUE},
    {SYM_ANY_PLAIN_VALUE_X, TS_PLAIN_VALUE},
    {SYM_ANY_SET_VALUE_X, TS_SET_VALUE},
    {SYM_ANY_GET_VALUE_X, TS_GET_VALUE},
    {SYM_ANY_META_VALUE_X, TS_META_VALUE},
