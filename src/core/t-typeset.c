...
const struct {
    ...
    {SYM_ANY_THE_TYPE_X, TS_THE_TYPE},
    {SYM_ANY_PLAIN_TYPE_X, TS_PLAIN_TYPE},
    {SYM_ANY_SET_TYPE_X, TS_SET_TYPE},
    {SYM_ANY_GET_TYPE_X, TS_GET_TYPE},
    {SYM_ANY_META_TYPE_X, TS_META_TYPE},
