...
// Moment of Zen: just calling it Month_Lengths might make it easy to
// forget February isn't always 28 days!  Always consider
// little opportunities in naming that preempt bugs. -@HF
const REBYTE Typical_Month_Lengths[12] = {
