...
***********************************************************************/
{
	...
	if (copy) {
		FRM_WORD_SERIES(frame) = Copy_List_Extra_Shallow(words, delta);
	} else {
...
***********************************************************************/
{
	...
	prior = Copy_List_Shallow(BUF_WORDS);
	RESET_TAIL(BUF_WORDS);  // allow reuse
...
***********************************************************************/
{
	...
	series = Copy_List_At_Max_Shallow(
...
***********************************************************************/
{
	...
	wrds = Copy_List_Shallow(BUF_WORDS);
